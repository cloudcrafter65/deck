          ...
          >
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-6 mb-8">
              <p className="text-lg leading-relaxed">
                Market-facing APAC CTO-calibre technology executive with <strong>20+ years</strong> at the
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              {/* Core Impact */}
              <div>
                <p className="text-xs tracking-[0.2em] text-white/50 mb-4">CORE IMPACT</p>
                <ul className="space-y-3">
                  {coreImpact.map((item, i) => (
                    ...
                    >
                      ...
                      <span>
                        <strong className="text-blue-400">{item.highlight}</strong>{' '}
              ...
              {/* Experience */}
              <div>
                <p className="text-xs tracking-[0.2em] text-white/50 mb-4">EXPERIENCE</p>
                <ul className="space-y-3">
                  {experience.map((item, i) => (
                    ...
                    >
                      <svg className="w-4 h-4 text-white/50 mt-1 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                      </svg>
                      <span>
                        <strong>{item.company}</strong>
                        {item.role && <span className="text-white/50"> — {item.role}</span>}
                      </span>
                    </motion.li>
                  ))}
                </ul>
            ...
            >
              {skills.map((skill) => (
                <span
                  key={skill}
                  className="px-4 py-2 border border-blue-400/50 text-blue-400 rounded-full text-sm"
                >
                  {skill}
                </span>
              ))}
